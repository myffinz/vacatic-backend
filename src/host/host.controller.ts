...
export class HostController {
    ...
    async addBankAccount(@Param('hostId') hostId: string, @Body('addBankAccount') addBankAccount: HostBankAccDto) {
        return this.hostService.hostUpdateBankAccount(hostId, addBankAccount);
    }
